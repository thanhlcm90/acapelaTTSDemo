...
public class androidTTSDemo extends Activity implements iTTSEventsCallback {
	Button loadButton;
	Button unloadButton;
	Button speakButton;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Please contact acapela support if you didn't receive yours
		TTS.setLicense(
				0x444e4153,
				0x00306483,
		...
		// Remove this alert dialog once license set
		// AlertDialog.Builder LicenseDialog = new AlertDialog.Builder(this);
		// LicenseDialog.setTitle("License");
		// LicenseDialog.setMessage("You need to insert your license in the source code");
		// LicenseDialog.setPositiveButton("OK",new
		...
		// Get Voices list
		String[] voiceDirPaths = { "/sdcard1/acattsandroid", "/sdcard/voices" };
	...
	public void ttsevents(long type, long param1, long param2, long param3,
		...
		if (type == acattsandroid.EVENT_TEXT_START)
			...
			Log.i(TAG, "word " + param1 + " - " + param2);
			if ((int) (param1 + param2) <= texttospeak.length()) {
				// String word =
				// texttospeak.substring((int)param1,(int)(param1+param2));
				// Log.i(TAG, "Word " + word + " pos : " + param1 + " - len : "
				// + param2 + " - sampval : " + param3 );
